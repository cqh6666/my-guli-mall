...
import com.haige.gulimall.product.service.SpuImagesService;
...
public class SpuImagesServiceImpl extends ServiceImpl<SpuImagesDao, SpuImagesEntity> implements SpuImagesService {
    ...
    @Override
    public void saveSpuImages(Long id, List<String> infoImages) {
        if(!CollectionUtils.isEmpty(infoImages)){
            List<SpuImagesEntity> imagesEntityList = infoImages.stream().map(image -> {
